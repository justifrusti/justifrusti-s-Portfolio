                    ...
                    if(isLandTile || isEdgeTile)
                    {
                        for (int i = 0; i < nswe.Length; i++)
                        {
                            ...
                            if(neighbourIsOutOfBounds || (isLandTile && neighbourIsWater))
                            {
                                ...
                                int edgeVertIndexA = sideVertexIndexByDir[i][0];
                                int edgeVertIndexB = sideVertexIndexByDir[i][1];
                                ...
                                int[] sideTriIndeces = { vertIndex, vertIndex + 1, vertIndex + 2, vertIndex + 1, vertIndex + 3, vertIndex + 2 };

                                triangles.AddRange(sideTriIndeces);
