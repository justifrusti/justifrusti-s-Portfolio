...
public class Animal : LivingEntity
{
    ...
    public override void Init(Coord coord)
    {
        ...
        material.color = (genes.isMale) ? maleColor : femaleColor;
    ...
    protected void StartMoveToCoord(Coord target)
    {
        ...
        moveArcHeightFactor = (diagonalMove) ? oneOverSqrtTwo : 1;
    ...
    void HandleInteractions()
    {
        if(currentAction == CreatureAction.Eating)
        {
            ...
            {
                float eatAmmount = Mathf.Min(hunger, Time.deltaTime * 1 / eatDuration);
                eatAmmount = ((Plant)foodTarget).Consume(eatAmmount);
