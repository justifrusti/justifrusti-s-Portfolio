...
{
    [SerializeField] private float panRate = 1f;
    [SerializeField] private float yawRate = 90f;
    [SerializeField] private float pitchRate = 45f;
    [SerializeField] private float zoomRate = 10000f;

    [SerializeField] private float maxPanDistance = 30000f;
    [SerializeField][MinMax()] private Vector2 minMaxPitchAngle = new Vector2(30, 90);
    [SerializeField][MinMax()] private Vector2 minMaxZoomDistance = new Vector2(3000f, 50000f);

    [SerializeField] private float defaultYawAngle = 0f;
    [SerializeField] private float defaultPitchAngle = 20f;
    [SerializeField] private float defaultZoom = 100f;
    [SerializeField] private float camResetRate = 2f;
