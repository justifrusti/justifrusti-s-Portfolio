...
public class HUDInterface : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI timestepReadout;
    [SerializeField] private TextMeshProUGUI yearReadout;
    [SerializeField] private TextMeshProUGUI dayReadout;
    [SerializeField] private TextMeshProUGUI hourReadout;
    [SerializeField] private TextMeshProUGUI minuteReadout;
    [SerializeField] private TextMeshProUGUI secondReadout;
    [Space]
    [SerializeField] private TextMeshProUGUI observedHeader;
    [SerializeField] private observedDistance[] observedDistances;
    ...
    private void UpdateTimeStepGUI()
    {
        ...
        timestepReadout.text = "Timestep: " + (timestepValue == 0 ? "RT" : timestepValue.ToString());
