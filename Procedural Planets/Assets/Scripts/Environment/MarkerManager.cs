...
{
    [SerializeField] private BodyMarker markerPrefab;
    ...
    public static void RegisterMarker(CelestialBody celestialBody, float maxDisplayDst)
    {
        ...
        markerInstance.InitializeMarker(Instance.markerCanvas, celestialBody, maxDisplayDst);
