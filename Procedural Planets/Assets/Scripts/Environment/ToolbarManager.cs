...
public class ToolbarManager : MonoBehaviour
{
    ...
    [SerializeField] private bool toolbarOpen = true;
    [SerializeField] private float toolbarToggleRate = 10f;
    [SerializeField] private VerticalLayoutGroup toolbarLayoutGroup;
    [SerializeField] private Animator toolbarToggleAnim;
    [SerializeField] private GameObject layersPanel;
    [SerializeField] private GameObject shadingPanel;
    ...
    private void Update()
    {
        toolbarLayoutGroup.spacing = Mathf.Lerp(toolbarLayoutGroup.spacing, toolbarOpen ? 5f : -40f, toolbarToggleRate * Time.deltaTime);
    }
    ...
    {
        gridPlane.ToggleGridVisibility();
    }
