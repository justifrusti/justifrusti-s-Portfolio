...
public static class MathHelper
{
    ...
    /// <summary>
    /// Normalizes a value between 0 - 1 given the minimum and maximum of the given value. E.g. Normalize(0, -1, 1) = 0.5
    /// </summary>
    ...
    public static Vector3[] SampleEllipse(float semiMajor, float semiMinor, Vector3 centre, int resolution = 1000, float theta = 0f)
    {
        ...
        for (int i = 0; i <= resolution; i++)
        {
            ...
            points[i] = rot * new Vector3(x, 0f, y) + centre;
        }
