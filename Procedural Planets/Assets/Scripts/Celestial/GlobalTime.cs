...
public class GlobalTime : MonoBehaviour
{
    ...
    [SerializeField][Range(0f, 60f)] private float minute;
    [SerializeField][Range(0f, 60f)] private float hour;
    [SerializeField][Range(0f, 24f)] private float day;
    [SerializeField][Range(0f, 365f)] private float year;
